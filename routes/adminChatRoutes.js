...
router.post("/", authDebugMiddleware, adminChatController.createAdminChat);

// Get all chats for the authenticated user
router.get("/", authDebugMiddleware, adminChatController.getChats);
...
router.post(
  ...
  adminChatController.uploadImage
);
