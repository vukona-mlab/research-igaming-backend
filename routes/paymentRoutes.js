...
// Payment routes
router.post('/process-payment', checkProfileCompleted, paymentController.createOrder);
router.get('/payment-history', checkProfileCompleted, paymentController.getPaymentHistory);
